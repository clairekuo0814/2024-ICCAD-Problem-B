...
public:
    ...
    void bitOrdering();
    bool chooseCandidateFF(const Coor& legalCoor, std::vector<PointWithID>& resultFFs, std::vector<PointWithID>& toRemoveFFs, std::vector<FF*> &FFToBank, const int &bit, const std::vector<bool> &isClustered, const PointWithID& curFF);
